<template>
  ...
  <ModalDialog id="creditsModal" :title="t('footer.credits')">
    <template #body>
      <h4><a href="https://boardgamegeek.com/boardgame/339789/welcome-to-the-moon" target="_blank" rel="noopener">{{t('gameTitle')}}</a></h4>
      <dl>
        <dt>Game design</dt>
        <dd>Benoit Turpin, Alexis Allard</dd>
        <dt>Artist</dt>
        <dd>Anne Heidsieck</dd>
        <dt>Publisher</dt>
        <dd><a href="https://bluecocker.com/" target="_blank" rel="noopener">Blue Cocker Games</a></dd>
      </dl>
      ...
      <dl>
        ...
        <dt>Version</dt>
        <dd>{{buildNumber}} (<a href="https://github.com/brdgm/welcome-to-the-moon-solo-helper/releases" target="_blank" rel="noopener">Change Log</a>)</dd>
        <dt>Source Code (Apache-2.0 License)</dt>
        <dd><a href="https://github.com/brdgm/welcome-to-the-moon-solo-helper" target="_blank" rel="noopener">https://github.com/brdgm/welcome-to-the-moon-solo-helper</a></dd>
      </dl>
